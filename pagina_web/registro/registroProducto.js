function driner(){
    ...
    descripcion: document.getElementById("descripcion").value,
      ...
      imagenes: document.getElementById("file").value.substr(11)
      ...
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          ...
          if (response.status === 'success') {
            console.log("Productos guardado correctamente.");
            ...
            console.log("Error al guardar el proveedor: " + response.message);
          }
        } else {
